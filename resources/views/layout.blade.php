...
<div class="vd to/4 tc wf yf">
  <a href="index.html">
    <img class="om" src="{{ asset('images/Picture2.png')}}" alt="Logo Light" />
    <img class="xc nm" src="{{ asset('images/Picture2.png')}}" alt="Logo Dark" />
  </a>
...
>
  ...
  <div class="tc wf ig pb no">
    ...
    <a href="signup.html" :class="{ 'hh/[0.15]' : page === 'home', 'sh' : page === 'home' }" class="lk gh dk rg tc wf xf _l gi hi">Sign Up</a>
  </div>
</div>
</div>
</header>
...
<main>
  ...
  <section class="gj do ir hj sp jr i pg">
    ...
    <div class="xc fn zd/2 2xl:ud-w-187.5 bd 2xl:ud-h-171.5 h q r">
      ...
      {{-- <img src="{{ asset('images/carton-boxes.png')}}" alt="Woman" class="h q r ua" /> --}}
    </div>
    ...
    <div class="bb ze ki xn 2xl:ud-px-0">
      <div class="tc _o">
        <div class="animate_left jn/2">
          <h1 class="fk vj zp or kk wm wb">Notre spécialité est l'importation de pièces authentiques</h1>
          <p class="fq">
      ...
      <div class="tc wf gg qq">
        ...
        <div class="animate_left xc gn gg jn/2 i">
          <div>
            ...
            <img src="{{ asset('images/mechanic-holding-pair-wrenches-repair-garage.jpg')}}" alt="About" class="ib" />
            <img src="{{ asset('images/auto-mechanic-working-garage-repair-service.jpg')}}" alt="About" />
          </div>
          <div>
            {{-- <img src="{{ asset('images/shape-06.svg')}}" alt="Shape" /> --}}
            {{-- <img src="{{ asset('images/Picture3.jpg')}}" alt="About" class="ob gb" /> --}}
  ...
  <section class="i pg ji gp uq">
    ...
    {{-- <img src="{{ asset('images/j.png')}}" alt="Shape" style="height: 20%" class="h _ aa" /> --}}
    <img src="{{ asset('images/j.png')}}" alt="Shape" style="height: 20%" class="of h m ba" />
    {{-- <img src="{{ asset('images/brake.png')}}" style="height: 20%" alt="Shape" class="of h m ba" /> --}}
    <img src="{{ asset('images/brake.png')}}" class="h _ aa" style="height: 20%" alt="Shape" />
    <!-- Section Title Start -->
    <div
      ...
      <div class="wc qf pn xo gg cp">
        ...
        <div class="animate_top rj">
          <div class="c i pg z-1">
            <img class="vd" src="{{ asset('images/accueil-pieces-auto-7de2181c.webp')}}" alt="Team" />
          ...
          <h4 class="yj go kk wm ob zb">Produits Originaux</h4>
          <p>Product Manager</p>
        </div>
        ...
        <div class="animate_top rj">
          <div class="c i pg z-1">
            <img class="vd" src="{{ asset('images/accueil-atelier-de-reparation-d124e801.webp')}}" alt="Team" />
          ...
          <h4 class="yj go kk wm ob zb">Atelier de Réparation</h4>
        ...
        <div class="animate_top rj">
          <div class="c i pg z-1">
            <img class="vd" src="{{ asset('images/accueil-livraison-d4ab42d4.webp')}}" alt="Team" />
          ...
          <h4 class="yj go kk wm ob zb">Livraison Disponible</h4>
          <p>Web Designer</p>
        </div>
      </div>
    </div>
...
<p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
  ...
  <section x-data="setup()" class="i pg fh rm ji gp uq">
    ...
    <!-- Section Title Start -->
    <div id="pop-up-picture" style="display: none;">
      <img src="{{ asset ('mahle.jpg')}}" alt="Pop-up image description">
  </div>
  
    <div>
        {{-- <img src="{{ asset('images/36479-034158.svg') }}" alt=""> --}}
        <object class="map-container" id="world-map" type="image/svg+xml" data="{{ asset('images/world (1).svg') }}"></object>
      <div class="animate_top bb ze rj ki xn vq">
<h2
        x-text="sectionTitle"
        class="fk vj pr kk wm on/5 gq/2 bb _b"
...
<div class="ji gp">
  <div class="tc uf ap gg fp">
    <div class="animate_top zd/2 to/4">
      <a href="index.html">
        <img src="{{ asset('images/Picture1.png') }}" alt="Logo" class="om" />
        <img src="{{ asset('images/Picture1.png') }}" alt="Logo" class="xc nm" />
      </a>
